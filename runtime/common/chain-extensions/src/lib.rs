...
impl<C: pallet_contracts::Config + pallet_tokens::Config> ChainExtension<C> for Web3gamesExtensions<C> {
		...
		<E::T as SysConfig>::AccountId: UncheckedFrom<<E::T as SysConfig>::Hash> + AsRef<[u8]>,
	{
        match func_id {
            1024 => {
                ...
                let random_slice = <E::T as pallet_contracts::Config>::Randomness::random_seed().0.encode();
                log::trace!(
                    target: "runtime",
            ...
            // 0x800 - 0x880
            id if id >= 2048 && id < 2176 => {
                TokensExtension::call(func_id, env)
            }
            _ => {
