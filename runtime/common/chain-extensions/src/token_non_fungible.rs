            ...
            <E::T as SysConfig>::AccountId: UncheckedFrom<<E::T as SysConfig>::Hash> + AsRef<[u8]>,
    {
        match func_id {
            ...
            65601 => {
                ...
                let id = pallet_token_non_fungible::Pallet::<E::T>::do_create_token(&caller, name, symbol, base_uri)?;
            ...
            65602 => {
                ...
                let id: <E::T as pallet_token_non_fungible::Config>::NonFungibleTokenId = env.read_as()?;
                let to: <E::T as SysConfig>::AccountId = env.read_as()?;
                let token_id: TokenId = env.read_as()?;


                let call =
                    <E::T as pallet_contracts::Config>::Call::from(pallet_token_non_fungible::Call::<
                        E::T,
                    >::approve {
                        id,
                        to,
            ...
            65607 => {
                ...
                let exists: bool =
                    pallet_token_non_fungible::Pallet::<E::T>::exists(id);
