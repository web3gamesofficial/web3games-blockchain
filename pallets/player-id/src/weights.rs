...
//! Autogenerated weights for pallet_player_id
//!
...
/// Weight functions needed for pallet_player_id.
...
/// Weights for pallet_player_id using the Web3Games node and recommended hardware.
