...
use crate as web3games_launchpad;
use frame_support::{
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Launchpad: web3games_launchpad::{Pallet, Call, Storage, Event<T>},
	}
);
...
parameter_types! {
	pub const LaunchpadPalletId: PalletId = PalletId(*b"w3g/lpad");
}

impl web3games_launchpad::Config for Test {
	type Event = Event;
