...
//! Autogenerated weights for web3games_launchpad
//!
...
/// Weight functions needed for web3games_launchpad.
...
/// Weights for web3games_launchpad using the Web3Games node and recommended hardware.
