...
//         let amount_b_min :Balance = 0u128;
//         let to = 0u64;
//         assert_ok!(Exchange::add_liquidity(origin.clone(),id.clone(),amount_a_desired,amount_b_desired,amount_a_min.clone(),amount_b_min.clone(),to.clone()));
//         let token_a:FungibleTokenId = 0;
//         let token_b:FungibleTokenId = 1;
//         let liquidity:Balance = 1000000u128;
//         assert_ok!(Exchange::remove_liquidity(origin,id,token_a,token_b,liquidity,amount_a_min,amount_b_min,to));
//     })
// }