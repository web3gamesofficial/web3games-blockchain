...
//! Autogenerated weights for pallet_call_switchgear
//!
...
/// Weight functions needed for pallet_call_switchgear.
pub trait WeightInfo {
	fn switchoff_transaction() -> Weight;
	fn switchon_transaction() -> Weight;
}

/// Weights for pallet_call_switchgear using the Web3Games node and recommended hardware.
