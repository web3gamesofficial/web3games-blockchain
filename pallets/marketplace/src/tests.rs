...
fn test_remove_sale_works() {
    new_test_ext().execute_with(|| {
        ...
        let price:Balance = 10000;
        let amount:Balance = 1;
        assert_ok!(Marketplace::add_sale(origin.clone(),collection_id.clone(),token_id,price,amount));
...
fn test_update_amount_works() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(TokenMulti::mint(origin.clone(), id.clone(), to, token_id.clone(),amount.clone()));
...
fn test_offer_works() {
    new_test_ext().execute_with(|| {
        ...
        let price:Balance = 10000;
        let amount:Balance = 1;
        assert_ok!(Marketplace::add_sale(origin.clone(),collection_id.clone(),token_id,price.clone(),amount));
