...
//! Autogenerated weights for web3games_wrap_currency
//!
...
// --steps=50
// --repeat=20
// --pallet=web3games_wrap_currency
// --extrinsic=*
// --execution=wasm
// --wasm-execution=compiled
// --output=./pallets/wrap-currency/src/weights.rs
...
/// Weight functions needed for web3games_wrap_currency.
pub trait WeightInfo {
	fn deposit() -> Weight;
	fn withdraw() -> Weight;
}

/// Weights for web3games_wrap_currency using the Web3Games node and recommended hardware.
pub struct W3GWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> WeightInfo for W3GWeight<T> {
	// Storage: System Account (r:2 w:2)
	// Storage: WrapCurrency WrapToken (r:1 w:0)
