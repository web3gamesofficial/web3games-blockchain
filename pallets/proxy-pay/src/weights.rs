...
//! Autogenerated weights for web3games_exchange
//!
...
/// Weight functions needed for web3games_exchange.
...
/// Weights for web3games_exchange using the Web3Games node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for W3GWeight<T> {
	...
	// Storage: Exchange PoolIdToToken (r:0 w:1)
	fn create_pool() -> Weight {
